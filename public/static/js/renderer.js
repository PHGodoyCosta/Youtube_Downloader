        ...
        if (converterOptions.typeUnity == "musica") {
            ...
            if (checkYoutubeURL(text)) {
                ...
                if (videoId) {
                    ...
                    createMusicLoadingElement(informations.poster, informations.title, duration=informations.duration, type=converterOptions.type)
            ...
            for (let i=0;i<informations.playlist_count;i++) {
                ...
                createMusicLoadingElement(musica.poster.url, musica.title, duration=musica.duration, type=converterOptions.type)
